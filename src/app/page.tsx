...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-hop-green to-green-800">
      {/* Header */}
      <div className="bg-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
            ...
            <p className="text-xl text-hop-green font-semibold">
              Hop-Themed Fantasy Football Awards
            </p>
            <p className="text-gray-600 mt-2">
              From the bine to the shrine - tracking the best and worst of the season
            </p>
          </div>
        </div>
      </div>
